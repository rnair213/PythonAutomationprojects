...
class Test_login(BaseTest):
    ...
    def test_socialsecuritytoggle(self, Current_age, retire_age, current_income, spouse_income, Current_tol_saving, current_an_saving,
                   sav_inc_rate):
        self.driver.get("https://www.securian.com/insights-tools/retirement-calculator.html")
        '''Browser is loaded and site up and running'''
        ...
        try:
            ...
            '''filling up the forms with required fields'''
        ...
        try:
            ...
            if status:
                ...
                self.driver.find_element(By.XPATH,"//input[@id='social-security-override']").send_keys("2000")
        except NoSuchElementException:
            print("exception")
